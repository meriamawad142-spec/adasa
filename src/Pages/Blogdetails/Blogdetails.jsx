...
export default function Blogdetails() {
  ...
  const headings = sections
    ...
    .filter((item) => item.section.startsWith("##"));
              ...
              <div class="mt-6 p-6 bg-[#111111] rounded-2xl border border-[#262626]">
                <div class="flex items-center justify-between flex-wrap gap-4">
                  <div class="flex items-center gap-3">
                    ...
                    <h3 class="font-bold text-white">شارك المقال</h3>
                  </div>
                  <div class="flex gap-2">
                    ...
                    <button class="w-11 h-11 bg-[#1a1a1a] border border-[#262626] rounded-xl flex items-center justify-center text-neutral-400 hover:bg-[#25d366] hover:text-white hover:border-transparent transition-all duration-300">
                      <i class="fa-brands fa-whatsapp"></i>
                    </button>
                    <button class="w-11 h-11 bg-[#1a1a1a] border border-[#262626] rounded-xl flex items-center justify-center text-neutral-400 hover:bg-orange-500 hover:text-white hover:border-transparent transition-all duration-300">
              ...
              <div className="mt-6 p-8 bg-gradient-to-br from-[#161616] to-[#111111] rounded-2xl border border-[#262626]">
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                  ...
                  <div class="text-center sm:text-right flex-1">
                    <span class="text-xs text-orange-500 font-semibold uppercase tracking-wider">
                      كاتب المقال
                    </span>
          ...
          <div className="mt-20 pt-12 border-t border-[#262626]">
            <div className="flex items-center justify-between mb-10">
              <div class="flex items-center gap-4">
                <span class="w-12 h-12 bg-orange-500/10 rounded-2xl flex items-center justify-center border border-orange-500/30">
                  <i class="fa-solid fa-images text-orange-500 text-xl"></i>
                </span>
                <div>
              ...
              <Link
                class="hidden sm:flex items-center gap-2 text-orange-500 hover:text-orange-400 transition-colors group"
                href="/blog"
              >
                عرض الكل
